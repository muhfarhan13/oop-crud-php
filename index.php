            ...
            <table class="table table-bordered" border=1>
                ...
                ?>
                    <tr>
                        ...
                        <td><a class="badge badge-success" href="detail-warga.php?id=<?php echo $data['id']; ?>">detail</a> <a class="badge badge-danger" href="index.php?hapus=<?php echo $data['id']; ?>">Hapus</a></td>
                    </tr>
                <?php } ?>
            </table>
        </div>
